...
<!--          </tr>-->
    ...
    <div class="main-content-wrapper">
      ...
      <div class="right-wrapper">
        ...
        <div class="head">
          <h4><input type="text" class="form-control" placeholder="搜索" v-model="search"></h4>
    ...
    <Modal
        ...
        用户名：<Input v-model="docContentName" placeholder="输入用户名" />
        公司名称：<Input v-model="docContentName" placeholder="输入公司名称" />
        公司地址<Input v-model="docContentName" placeholder="输入公司地址" />
        公司电话<Input v-model="docContentName" placeholder="输入公司电话" />
    </Modal>
  </div>
</template>
